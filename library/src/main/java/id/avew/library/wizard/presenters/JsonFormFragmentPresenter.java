package id.avew.library.wizard.presenters;
...
import id.avew.library.wizard.interactor.JsonFormInteractor;
import id.avew.library.wizard.mvp.MvpBasePresenter;
import id.avew.library.wizard.utils.CarouselAdapter;
import id.avew.library.wizard.utils.DateUtils;
import id.avew.library.wizard.utils.ImagePicker;
...
import id.avew.library.wizard.widget.CarouselFactory;
import id.avew.library.wizard.widget.DatePickerFactory;
import id.avew.library.wizard.widget.EditTextFactory;
...
public class JsonFormFragmentPresenter extends MvpBasePresenter<JsonFormFragmentView<JsonFormFragmentViewState>> {
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
        if (compoundButton instanceof CheckBox) {
            ...
            getView().writeValue(mStepName, parentKey, JsonFormConstants.OPTIONS_FIELD_NAME, childKey,
                    String.valueOf(compoundButton.isChecked()));
